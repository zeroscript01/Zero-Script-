...
local Window = OrionLib:MakeWindow({Name = "ZERO SCRIPT HUB", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "ZERO SCRIPT HUB"})
...
W:AddLabel("[+] ZERO SCRIPT HUB is HERE!")
